 ...
 */
public class ImageMovieBannerWidget extends AppWidgetProvider {
    ...
    public static final String UPDATE_WIDGET = "com.example.submission5.UPDATE_WIDGET";
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.image_movie_banner_widget);
        views.setRemoteAdapter(R.id.stack_view, intent);
        views.setEmptyView(R.id.stack_view, R.id.empty_view);

        Intent toastIntent = new Intent(context, ImageMovieBannerWidget.class);
        toastIntent.setAction(ImageMovieBannerWidget.TOAST_ACTION);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(UPDATE_WIDGET)){
            ...
            int[] ids = gm.getAppWidgetIds(new ComponentName(context, ImageMovieBannerWidget.class));
