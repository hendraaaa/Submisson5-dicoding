package com.example.myfavorite.entity;
...
import static com.example.myfavorite.db.DatabaseConstract.MovieColumns.DESKRIPSI;
import static com.example.myfavorite.db.DatabaseConstract.MovieColumns.GAMBAR;
import static com.example.myfavorite.db.DatabaseConstract.MovieColumns.JUDUL;
import static com.example.myfavorite.db.DatabaseConstract.MovieColumns.RILIS;
...
public class Movies implements Parcelable {
   ...
   public Movies(){
    ...
    public Movies(int idMovie, String titleMovie, String descMovie, String releaseDateMovie, String posterMovie, String voteMovie){
        this.idMovie = idMovie;
        this.titleMovie = titleMovie;
        this.descMovie = descMovie;
        this.releaseDateMovie = releaseDateMovie;
   ...
   public Movies(Cursor cursor){
       this.idMovie = DatabaseConstract.getColumnInt(cursor,_ID);
